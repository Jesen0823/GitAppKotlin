...
public class AppCompatAvatarImageView extends AppCompatImageView {
    ...
    public AppCompatAvatarImageView(Context context) {
        super(context);
        init();
    }

    public AppCompatAvatarImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttr(context, attrs);
        init();
    }

    public AppCompatAvatarImageView(Context context, AttributeSet attrs, int defStyleAttr) {
