...
public class FixLuRecyclerView extends RecyclerView {
    ...
    public FixLuRecyclerView(Context context) {
        this(context, null);
    }

    public FixLuRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FixLuRecyclerView(Context context, AttributeSet attrs, int defStyle) {
            ...
            if (adapter instanceof LRecyclerViewAdapter) {
                ...
                if (lRecyclerViewAdapter.getInnerAdapter() != null && mEmptyView != null) {
                    ...
                    if (count == 0) {
                        ...
                        FixLuRecyclerView.this.setVisibility(View.GONE);
                    } else {
                        mEmptyView.setVisibility(View.GONE);
                        FixLuRecyclerView.this.setVisibility(View.VISIBLE);
                    }
                }
            } else {
